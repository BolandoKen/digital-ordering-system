...
class QaddDialog(QStyledDialog) :
    ...
    def init_addFood(self) :
        ...
        self.foodnameLabel.setStyleSheet("font-family: Helvetica; font: 30px; color: #A1A1A1; font-weight: bold;")
        self.foodnameLineEdit = QFormLineEdit()
        self.foodnameLineEdit.setFixedSize(529,70)
        self.foodpriceLabel = QLabel("Price ")
        self.foodpriceLabel.setStyleSheet("font-family: Helvetica; font: 30px; color: #FFCA40; font-weight: bold;")
        self.foodpriceLineEdit = QFormLineEdit()
        self.foodpriceLineEdit.setFixedSize(529,70)
        ...
        self.categoryidLabel.setStyleSheet("font-family: Helvetica; font: 30px; color: #A1A1A1; font-weight: bold;")
        self.categoryidLabel.hide()
        self.categoryidComboBox = QCatComboBox()
        self.categoryidComboBox.setFixedSize(529,70)
        ...
        self.dialog_layout.addWidget(self.foodnameLabel,0,2,1,1, Qt.AlignmentFlag.AlignBottom)
        self.dialog_layout.addWidget(self.foodnameLineEdit,1,2,1,3)
        self.dialog_layout.addWidget(self.foodpriceLabel,2,2,1,1, Qt.AlignmentFlag.AlignBottom)
        self.dialog_layout.addWidget(self.foodpriceLineEdit,3,2,1,3)
        self.dialog_layout.addWidget(self.categoryidLabel,4,2,1,1, Qt.AlignmentFlag.AlignBottom)
        self.dialog_layout.addWidget(self.categoryidComboBox,5,2,1,3)
        self.dialog_layout.addWidget(self.cancelBtn, 7,3,1,1)
        self.dialog_layout.addWidget(self.submitBtn,7,4,1,1)
